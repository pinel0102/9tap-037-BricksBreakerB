		...
		if(CSceneManager.IsExistsMainCamera) {
			...
			try {
				var oAdsPosList = new List<Vector3>() {
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(CSceneManager.CanvasSize.x / -KCDefine.B_VAL_2_REAL, (CSceneManager.CanvasSize.y / -KCDefine.B_VAL_2_REAL) + (CAccess.GetBannerAdsHeight(KCDefine.U_SIZE_BANNER_ADS.y) * CAccess.ResolutionScale), KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale,
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(CSceneManager.CanvasSize.x / -KCDefine.B_VAL_2_REAL, CSceneManager.CanvasSize.y / KCDefine.B_VAL_2_REAL, KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale,
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(CSceneManager.CanvasSize.x / KCDefine.B_VAL_2_REAL, CSceneManager.CanvasSize.y / KCDefine.B_VAL_2_REAL, KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale,
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(CSceneManager.CanvasSize.x / KCDefine.B_VAL_2_REAL, (CSceneManager.CanvasSize.y / -KCDefine.B_VAL_2_REAL) + (CAccess.GetBannerAdsHeight(KCDefine.U_SIZE_BANNER_ADS.y) * CAccess.ResolutionScale), KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale
				};
				...
				var oScreenPosList = new List<Vector3>() {
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(this.ScreenSize.x / -KCDefine.B_VAL_2_REAL, this.ScreenSize.y / -KCDefine.B_VAL_2_REAL, KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale,
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(this.ScreenSize.x / -KCDefine.B_VAL_2_REAL, this.ScreenSize.y / KCDefine.B_VAL_2_REAL, KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale,
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(this.ScreenSize.x / KCDefine.B_VAL_2_REAL, this.ScreenSize.y / KCDefine.B_VAL_2_REAL, KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale,
					stMainCameraPos + new Vector3(KCDefine.B_VAL_0_REAL, KCDefine.B_VAL_0_REAL, this.PlaneDistance) + new Vector3(this.ScreenSize.x / KCDefine.B_VAL_2_REAL, this.ScreenSize.y / -KCDefine.B_VAL_2_REAL, KCDefine.B_VAL_0_REAL) * CAccess.ResolutionUnitScale
				};
