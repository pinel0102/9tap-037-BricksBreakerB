...
namespace LoadingScene {
	...
	public abstract partial class CLoadingSceneManager : CSceneManager {
		...
		/** =====> UI <===== */
		public TMP_Text LoadingText => m_oTextDict.GetValueOrDefault(EKey.LOADING_TEXT);
		public CGaugeHandler LoadingGaugeHandler => m_oGaugeHandlerDict.GetValueOrDefault(EKey.LOADING_GAUGE_HANDLER);

		/** =====> 객체 <===== */
		public GameObject LoadingGauge => m_oUIsDict.GetValueOrDefault(EKey.LOADING_GAUGE);
		#endregion // 프로퍼티
