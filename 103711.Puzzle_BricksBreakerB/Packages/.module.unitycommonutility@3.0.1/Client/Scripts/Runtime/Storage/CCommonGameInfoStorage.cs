...
public partial class CCommonGameInfo : CCommonBaseInfo {
	...
	public float BGSndVolume {
		get { return float.Parse(m_oStrDict.GetValueOrDefault(KEY_BG_SND_VOLUME, KCDefine.B_STR_0_REAL)); }
		set { m_oStrDict.ExReplaceVal(KEY_BG_SND_VOLUME, $"{value}"); }
	}

	[IgnoreMember]
	public float FXSndsVolume {
		get { return float.Parse(m_oStrDict.GetValueOrDefault(KEY_FX_SNDS_VOLUME, KCDefine.B_STR_0_REAL)); }
