...
public partial class CGaugeHandler : CComponent {
	...
	public void SetPercent(float a_fPercent) {
		...
		m_oImgDict[EKey.MASK_IMG].fillAmount = KCDefine.B_VAL_1_REAL;

		m_oImgDict[EKey.PERCENT_IMG].fillAmount = KCDefine.B_VAL_1_REAL;
	...
	private void SetupPercent() {
		float fPercent = (m_oImgDict[EKey.MASK_IMG].fillOrigin <= (int)EFillOrigin._1) ? this.Percent : -this.Percent;
