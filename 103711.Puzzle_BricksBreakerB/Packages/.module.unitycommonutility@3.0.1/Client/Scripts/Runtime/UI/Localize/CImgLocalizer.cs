...
public partial class CImgLocalizer : CComponent {
	...
	private Dictionary<EKey, SystemLanguage> m_oSystemLanguageDict = new Dictionary<EKey, SystemLanguage>() {
		[EKey.SYSTEM_LANGUAGE] = SystemLanguage.Unknown
	};
	...
	public override void Start() {
		base.Start();
		this.SetImg(m_oBasePath, CCommonAppInfoStorage.Inst.CountryCode, CCommonAppInfoStorage.Inst.SystemLanguage);
	}
	...
	public void SetImg(string a_oBasePath) {
		this.SetImg(a_oBasePath, m_oStrDict[EKey.COUNTRY_CODE], m_oSystemLanguageDict[EKey.SYSTEM_LANGUAGE]);
	}
	...
	public void SetImg(string a_oBasePath, string a_oCountryCode, SystemLanguage a_eSystemLanguage) {
		...
		m_oSystemLanguageDict[EKey.SYSTEM_LANGUAGE] = a_eSystemLanguage;
	...
	private void SetupImg() {
		...
		string oImgPath = CFactory.MakeLocalizePath(m_oBasePath, oDefPath, m_oStrDict[EKey.COUNTRY_CODE], $"{m_oSystemLanguageDict[EKey.SYSTEM_LANGUAGE]}");
