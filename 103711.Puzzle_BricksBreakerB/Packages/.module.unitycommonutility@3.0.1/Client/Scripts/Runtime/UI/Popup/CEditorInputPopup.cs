...
public partial class CEditorInputPopup : CPopup {
	...
	/** =====> UI <===== */
	public InputField Input => m_oInputDict[EKey.INPUT];
	#endregion // 프로퍼티
	...
	private void OnTouchOKBtn() {
		this.Params.m_oCallbackDict?.GetValueOrDefault(ECallback.OK_CANCEL)?.Invoke(this, (m_oInputDict[EKey.INPUT] != null) ? m_oInputDict[EKey.INPUT].text : string.Empty, true);
