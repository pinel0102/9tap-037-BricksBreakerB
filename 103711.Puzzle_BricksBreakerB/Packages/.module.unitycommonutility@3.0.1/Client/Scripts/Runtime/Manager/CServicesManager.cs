...
public partial class CServicesManager : CSingleton<CServicesManager> {
	...
	public string AppleUserID {
		get {
#if UNITY_IOS && APPLE_LOGIN_ENABLE
			return m_oBoolDict[EKey.IS_INIT] ? CCommonAppInfoStorage.Inst.AppInfo.AppleUserID : string.Empty;
#else
			return string.Empty;
#endif // #if UNITY_IOS && APPLE_LOGIN_ENABLE
		}
	...
	public string AppleIDToken {
		get {
#if UNITY_IOS && APPLE_LOGIN_ENABLE
			return m_oBoolDict[EKey.IS_INIT] ? CCommonAppInfoStorage.Inst.AppInfo.AppleIDToken : string.Empty;
#else
			return string.Empty;
#endif // #if UNITY_IOS && APPLE_LOGIN_ENABLE
		}
	...
	public bool IsAppleLogin => m_oBoolDict[EKey.IS_APPLE_LOGIN];
	#endregion // 프로퍼티
