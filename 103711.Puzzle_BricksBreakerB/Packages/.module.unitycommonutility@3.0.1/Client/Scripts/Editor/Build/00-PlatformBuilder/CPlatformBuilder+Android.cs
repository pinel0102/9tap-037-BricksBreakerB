...
public static partial class CPlatformBuilder {
	...
	/** 구글 크리에이티브를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Creative/Google/Release with Auto Play", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 2)]
	...
	/** 아마존 크리에이티브를 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Creative/Amazon/Release with Auto Play", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 2)]
...
public static partial class CPlatformBuilder {
	...
	/** 안드로이드 구글을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/Google/Debug with Auto Play", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	...
	/** 안드로이드 구글을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/Google/Debug with Robo Test", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	...
	/** 안드로이드 구글을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/Google/Release with Auto Play", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
...
public static partial class CPlatformBuilder {
	...
	/** 안드로이드 아마존을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/Amazon/Debug with Auto Play", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	...
	/** 안드로이드 아마존을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/Amazon/Debug with Robo Test", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 101)]
	...
	/** 안드로이드 아마존을 빌드한다 */
	[MenuItem(KCEditorDefine.B_MENU_TOOLS_BUILD_BASE + "Local/Android/Amazon/Release with Auto Play", false, KCEditorDefine.B_SORTING_O_BUILD_MENU + 201)]
