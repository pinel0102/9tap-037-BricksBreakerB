...
/** 정지 팝업 */
public partial class CPiggyBankPopup : CSubPopup {
	/** 식별자 */
	public enum EKey {
		NONE = -1,
        RETRY_BTN,
	...
	public struct STParams {
		public Dictionary<ECallback, System.Action<CPiggyBankPopup>> m_oCallbackDict;
	}
    ...
    private void RefreshPiggyState()
    {
        //
    }

    public void OuTouchInfoButton()
    {
        //
    }
	...
	#region 클래스 함수
	/** 매개 변수를 생성한다 */
	public static STParams MakeParams(Dictionary<ECallback, System.Action<CPiggyBankPopup>> a_oCallbackDict = null) {
		return new STParams() {
			m_oCallbackDict = a_oCallbackDict ?? new Dictionary<ECallback, System.Action<CPiggyBankPopup>>()
		};
	}
	#endregion // 클래스 함수
}
