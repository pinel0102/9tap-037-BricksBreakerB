...
/** 정지 팝업 */
public partial class CStarterPackPopup : CSubPopup {
	/** 식별자 */
	public enum EKey {
		NONE = -1,
        RETRY_BTN,
	...
	public struct STParams {
		public Dictionary<ECallback, System.Action<CStarterPackPopup>> m_oCallbackDict;
	}
	...
	#region 클래스 함수
	/** 매개 변수를 생성한다 */
	public static STParams MakeParams(Dictionary<ECallback, System.Action<CStarterPackPopup>> a_oCallbackDict = null) {
		return new STParams() {
			m_oCallbackDict = a_oCallbackDict ?? new Dictionary<ECallback, System.Action<CStarterPackPopup>>()
		};
	}
	#endregion // 클래스 함수
}
