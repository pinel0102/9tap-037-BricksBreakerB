...
public partial class CPreviewPopup : CSubPopup {
	...
	private void UpdateUIsState() {
        ...
        int level = CSceneManager.GetSceneManager<GameScene.CSubGameSceneManager>(KCDefine.B_SCENE_N_GAME).Engine.currentLevel;
	...
	#region 클래스 함수
	/** 매개 변수를 생성한다 */
	public static STParams MakeParams(Dictionary<ECallback, System.Action<CPreviewPopup>> a_oCallbackDict = null) {
		return new STParams() {
