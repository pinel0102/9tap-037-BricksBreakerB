...
public partial class CPreviewPopup : CSubPopup {
	...
	private void UpdateUIsState() {
        ...
        goldenAimButton.gameObject.SetActive(!GlobalDefine.hasGoldenAim && !CUserInfoStorage.Inst.subscriptionActivated);
...
#region Booster
    ...
    {
        if (!GlobalDefine.isLevelEditor && !GlobalDefine.hasGoldenAim && !CUserInfoStorage.Inst.subscriptionActivated) 
        {
