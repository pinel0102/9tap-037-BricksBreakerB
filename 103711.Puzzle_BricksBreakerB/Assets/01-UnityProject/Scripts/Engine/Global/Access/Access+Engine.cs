...
namespace NSEngine {
	...
	public static partial class Access {
		...
		public static Vector3 CellSize => new Vector3(Access.MaxGridSize.x / (float)KDefine.E_DEF_NUM_CELLS.x, Access.MaxGridSize.y / (float)KDefine.E_DEF_NUM_CELLS.y, KCDefine.B_VAL_0_REAL);
