...
public static partial class GlobalDefine
{
    private static readonly Dictionary<EObjKinds, KeyValuePair<string, bool>> devComplete = new Dictionary<EObjKinds, KeyValuePair<string, bool>>()
    {
        ...
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_01]              = new KeyValuePair<string, bool>("워프 IN 1", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_02]              = new KeyValuePair<string, bool>("워프 IN 2", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_03]              = new KeyValuePair<string, bool>("워프 IN 3", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_04]              = new KeyValuePair<string, bool>("워프 IN 4", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_01]             = new KeyValuePair<string, bool>("워프 OUT 1", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_02]             = new KeyValuePair<string, bool>("워프 OUT 2", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_03]             = new KeyValuePair<string, bool>("워프 OUT 3", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_04]             = new KeyValuePair<string, bool>("워프 OUT 4", true),
