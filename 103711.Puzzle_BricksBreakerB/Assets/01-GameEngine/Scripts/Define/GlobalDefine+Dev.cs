...
public static partial class GlobalDefine
{
    private static readonly Dictionary<EObjKinds, KeyValuePair<string, bool>> devComplete = new Dictionary<EObjKinds, KeyValuePair<string, bool>>()
    {
        ...
        [EObjKinds.SPECIAL_BRICKS_ARROW_01]                 = new KeyValuePair<string, bool>("화살", false),
        [EObjKinds.SPECIAL_BRICKS_ARROW_02]                 = new KeyValuePair<string, bool>("화살", false),
        [EObjKinds.SPECIAL_BRICKS_ARROW_03]                 = new KeyValuePair<string, bool>("화살", false),
        [EObjKinds.SPECIAL_BRICKS_ARROW_04]                 = new KeyValuePair<string, bool>("화살", false),
        [EObjKinds.SPECIAL_BRICKS_ARROW_05]                 = new KeyValuePair<string, bool>("화살", false),
        [EObjKinds.SPECIAL_BRICKS_ARROW_06]                 = new KeyValuePair<string, bool>("화살", false),
        [EObjKinds.SPECIAL_BRICKS_ARROW_07]                 = new KeyValuePair<string, bool>("화살", false),
        [EObjKinds.SPECIAL_BRICKS_ARROW_08]                 = new KeyValuePair<string, bool>("화살", false),
        //[EObjKinds.SPECIAL_BRICKS_CLOCK_01]               = new KeyValuePair<string, bool>("변형 블럭", true),
        //[EObjKinds.SPECIAL_BRICKS_EARTHQUAKE_01]          = new KeyValuePair<string, bool>("지진 블럭", true),
