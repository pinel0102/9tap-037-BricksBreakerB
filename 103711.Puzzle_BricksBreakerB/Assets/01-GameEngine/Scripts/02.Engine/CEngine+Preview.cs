    ...
    public partial class CEngine : CComponent
    {
        ...
        private void SetupPreviewCell(STCellInfo a_stCellInfo, RectTransform preview) {
            ...
            for(int i = 0; i < a_stCellInfo.m_oCellObjInfoList.Count; ++i) {
                ...
                oCellObj.TargetSprite.transform.localPosition = GlobalDefine.GetSpriteCenter(CellSize, stObjInfo.m_stSize);

                oCellObj.TargetSprite.size = GlobalDefine.GetSpriteSize(CellSize, stObjInfo.m_stSize) + CELL_SPRITE_ADJUSTMENT;            
                ...
                oCellObj.UpperSprite.size = GlobalDefine.GetSpriteSize(CellSize, stObjInfo.m_stSize) + CELL_SPRITE_ADJUSTMENT;
