...
namespace NSEngine {
	...
	public partial class CECellObjController : CEObjController {
        ...
        private void GetSpecial_Refract(CEBallObjController ballController, EObjKinds kindsType, EObjKinds kinds, int _ATK = KCDefine.B_VAL_1_INT)
        {
            ...
            switch(kindsType)
            {
                case EObjKinds.SPECIAL_BRICKS_BALL_DIFFUSION_01:        Refract_Diffusion(ballController); break;
                case EObjKinds.SPECIAL_BRICKS_BALL_AMPLIFICATION_01:    Refract_Amplification(ballController); break;
                default: break;
            }
        ...
        {
            ballController.isNotAffect = true;
