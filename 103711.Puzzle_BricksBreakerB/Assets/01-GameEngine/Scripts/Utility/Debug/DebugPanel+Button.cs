...
public partial class DebugPanel : MonoBehaviour
{
    ...
    public void OnClick_ResetTime()
    {
        ...
        oCharacterGameInfo.PrevSubscriptionRewardTime = System.DateTime.Today.AddDays(-KCDefine.B_VAL_1_INT);
        oCharacterGameInfo.PrevSubscriptionAlertTime = System.DateTime.Today.AddDays(-KCDefine.B_VAL_1_INT);
