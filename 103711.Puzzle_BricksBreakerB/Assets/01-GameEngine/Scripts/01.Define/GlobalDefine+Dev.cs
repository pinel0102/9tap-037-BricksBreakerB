...
public static partial class GlobalDefine
{
    private static readonly Dictionary<EObjKinds, KeyValuePair<string, bool>> devComplete = new Dictionary<EObjKinds, KeyValuePair<string, bool>>()
    {
        ...
        [EObjKinds.OBSTACLE_BRICKS_KEY_01]                  = new KeyValuePair<string, bool>("열쇠", true),
        [EObjKinds.OBSTACLE_BRICKS_LOCK_01]                 = new KeyValuePair<string, bool>("자물쇠", true),
        ...
        [EObjKinds.OBSTACLE_BRICKS_OPEN_01]                 = new KeyValuePair<string, bool>("강철 블럭 (열림)", true),
        [EObjKinds.OBSTACLE_BRICKS_CLOSE_01]                = new KeyValuePair<string, bool>("강철 블럭 (닫힘)", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_01]              = new KeyValuePair<string, bool>("웜홀 IN 1", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_02]              = new KeyValuePair<string, bool>("웜홀 IN 2", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_03]              = new KeyValuePair<string, bool>("웜홀 IN 3", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_IN_04]              = new KeyValuePair<string, bool>("웜홀 IN 4", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_01]             = new KeyValuePair<string, bool>("웜홀 OUT 1", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_02]             = new KeyValuePair<string, bool>("웜홀 OUT 2", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_03]             = new KeyValuePair<string, bool>("웜홀 OUT 3", true),
        [EObjKinds.OBSTACLE_BRICKS_WARP_OUT_04]             = new KeyValuePair<string, bool>("웜홀 OUT 4", true),
