...
#region Project Settings
    ...
    public const string productName = "Bricks n Balls Editor";
#else
    public const string productName = "Bricks n Balls";
#endif
...
#region SDK Keys
    ...
    public const string ironSource_AppKey_AOS = "17056d7ad";
    public const string ironSource_AppKey_iOS = "170612e1d";
    public const string ironSource_Admob_AppID_AOS = "ca-app-pub-9834260879045639~9072776983";
    public const string ironSource_Admob_AppID_iOS = "ca-app-pub-9834260879045639~1357938495";

    // AppsFlyerManager.cs : 추가 작업 필요 없음.
    public const string appsflyer_dev_key = "J7eXAem8sBRuHTr3iX58d5";

    // FlurryManager.cs : 추가 작업 필요 없음.
    public const string flurry_Api_Key_AOS = "P68VWCZ4W8GPPCNKHNXR";
    public const string flurry_Api_Key_iOS = "WQG94NW32FXJPKG2V4XJ";
