...
public partial class CCharacterUserInfo : CObjTargetInfo {
	...
	private const string KEY_SEL_BALL_OBJ_KINDS = "SelBallObjKinds";
	#endregion // 상수
	...
	[IgnoreMember]
	public EObjKinds SelBallObjKinds {
		get { return (EObjKinds)int.Parse(m_oStrDict.GetValueOrDefault(KEY_SEL_BALL_OBJ_KINDS, $"{(int)EObjKinds.NONE}")); }
		set { m_oStrDict.ExReplaceVal(KEY_SEL_SKILL_SET_IDX, $"{(int)value}"); }
	}
	#endregion // 프로퍼티
...
public partial class CUserInfoStorage : CSingleton<CUserInfoStorage> {
    ...
    public bool IsPurchaseGoldenAim => Access.GetItemTargetVal(CGameInfoStorage.Inst.PlayCharacterID, EItemKinds.NON_CONSUMABLE_GOLDEN_AIM, ETargetKinds.ABILITY, (int)EAbilityKinds.STAT_NUMS) > KCDefine.B_VAL_0_INT;
	#endregion // 프로퍼티
